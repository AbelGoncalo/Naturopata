    ...
    <div class="card col-md-6">
        ...
        <div class="card-body col-md-12">
            ...
            <form wire:submit='login' method="POST">
                ...
                <button type="submit" class="btn  btn-lg btn-block" style="background-color: #ffbe33">Entrar</button>
                <div class="form-group text-center mt-4">
                  {{-- <span><a href="{{route('auth.signup')}}">Não possui uma conta?</a></span> <br> --}}
                  <span><a href="{{route('auth.signup')}}">Ainda não possui uma conta?</a></span><br>
                   <span><a href="#">Esqueceu suas credências?</a></span><br>
