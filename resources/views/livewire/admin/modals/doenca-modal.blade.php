<div wire:ignore.self data-backdrop='static' class="modal fade" id="doenca" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> {{($edit != '')? 'Actualizar':'Adicionar'}} Doenca</h5>
      ...
      <div class="modal-body">
        <form wire:submit='{{($edit != '')? 'update':'save'}}' id="basicform">
          <div class="form-group">
            ...
            <input id="doenca" type="text" wire:model='doenca' description="doenca" placeholder="nome a doenca" autocomplete="on" class="form-control">
            @error('doenca') <span class="text-danger">{{$message}}</span> @enderror
        </div>
          ...
          <div class="form-group">
            ...
            <p>Imagem Actual</p>
            <img class="img-fluid rounded" style="width: 100%;height:8rem; object-fit:cover" src="{{($edit != null) ? asset('storage/doencas/'.$imagem):''}}" alt="Imagem da doenca {{$doenca}}">
            @endif
          </div>
      </div>
