<div wire:ignore.self data-backdrop='static' class="modal fade" id="folha" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> {{($edit != '')? 'Actualizar':'Adicionar'}} Folha</h5>
      ...
      <div class="modal-body">
        <form wire:submit='{{($edit != '')? 'update':'save'}}' id="basicform">
          ...
          <div class="form-group">
            ...
            <select name="tipo" wire:model='tipo' id="tipo" class="form-control">
          ...
          @error('tipo') <span class="text-danger">{{$message}}</span> @enderror
            ...
            <div class="form-group">
              ...
              <p>Imagem Actual</p>
              <img class="img-fluid rounded" style="width: 100%;height:8rem; object-fit:cover" src="{{($edit != null) ? asset('storage/plantas/'.$imagem):''}}" alt="Imagem da folha {{$item->nome}}">
              @endif
            </div>
          </div>
