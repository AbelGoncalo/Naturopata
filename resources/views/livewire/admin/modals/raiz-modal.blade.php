<div wire:ignore.self data-backdrop='static' class="modal fade" id="raiz" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form wire:submit='{{($edit != '')? 'update':'save'}}' id="basicform">
          ...
          <div class="form-group">
            ...
            <p>Imagem Actual</p>
            <img class="img-fluid rounded" style="width: 100%;height:8rem; object-fit:cover" src="{{($edit != null) ? asset('storage/raizes/'.$imagem):''}}" alt="Imagem da raíz {{$item->nome}}">
            @endif
          </div>
      </div>
